  ...
  <article class="job-header flex">
    <div class="info-container flex">
      <div class="info">
        ...
        <p>
          <span class="job-header__company">NTG Clarity</span>
    ...
    <div class="apply flex">
      ...
      <div class="vector-icon__container">
        <img src="Vector.svg" alt="icon" class="vector-icon" />
      </div>
    </div>
  </article>
